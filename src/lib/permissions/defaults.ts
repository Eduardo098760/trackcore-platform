...
export const SUPER_ADMIN_PERMISSIONS: RoutePermissions = {
  dashboard: true, map: true, routes: true, vehicles: true, history: true, replay: true, events: true, commands: true,
...
export const READONLY_PERMISSIONS: RoutePermissions = {
  dashboard: true, map: true, routes: true, vehicles: true, history: true, replay: true, events: true, commands: false,
...
export const DENIED_ALL_PERMISSIONS: RoutePermissions = {
  dashboard: false, map: false, routes: false, vehicles: false, history: false, replay: false, events: false, commands: false,
