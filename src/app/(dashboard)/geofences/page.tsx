...
export default function GeofencesPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (
      ...
      toast.error("Finalize o desenho do poligono antes de salvar");
      return;
    }
  ...
  const handleFinishDrawing = () => {
    ...
    setFormData((prev) => ({
      ...prev,
      area: `POLYGON((${wktPoints}, ${drawingPoints[0][1]} ${drawingPoints[0][0]}))`,
    }));
            ...
            <div className="p-4 border-b flex-shrink-0">
              <DialogHeader>
                <DialogTitle className="text-lg">
                  {editingGeofence
                    ? "Editar Cerca Eletronica"
                    : "Nova Cerca Eletronica"}
                </DialogTitle>
              </DialogHeader>
            </div>
            ...
            <div className="flex-1 flex overflow-hidden">
              ...
              <div className="flex-1 relative">
                ...
                <div className="absolute top-4 left-4 bg-blue-600 text-white px-4 py-2 rounded-lg shadow-lg text-sm z-[1000]">
                  {formData.type === "polygon" &&
                    `Clique no mapa para marcar pontos (${drawingPoints.length} pontos)`}
                  {formData.type === "circle" &&
                    !circleCenter &&
                    "Clique para marcar o centro do circulo"}
                  {formData.type === "circle" &&
                    circleCenter &&
                    !circleRadius &&
                    "Clique para definir o raio"}
                  {formData.type === "rectangle" &&
                    drawingPoints.length === 0 &&
                    "Clique no primeiro canto do retangulo"}
                  {formData.type === "rectangle" &&
              ...
              >
                  ...
                  >
                    <div>
                      ...
                      <Input
                        ...
                        required
                        placeholder="Ex: Area de Entrega"
                        className="mt-1"
                      />
                    </div>
                        ...
                        <div className="p-3 space-y-2 border-t">
                          ...
                          >
                            ...
                            <span className="text-sm font-medium">
                              Todos os veiculos ({devices.length})
                            </span>
                          </div>
                    ...
                    <div className="pt-2 border-t">
                      {formData.area ? (
                        <p className="text-xs text-green-500">
                          Area desenhada com sucesso
                        </p>
                      ) : (
                        <p className="text-xs text-yellow-500">
                          Desenhe a area no mapa a esquerda
                        </p>
                      )}
                    </div>
                  </form>
                ...
                <div className="p-4 border-t space-y-2 flex-shrink-0">
                  <Button
                    type="submit"
                    form="geofence-form"
                    disabled={!formData.name || !formData.area || isSaving}
                    className="w-full"
                  >
                    {isSaving ? (
                      <>
