  ...
  useEffect(() => {
    ...
    const prefetch = async () => {
      await Promise.allSettled([
        ...
        queryClient.prefetchQuery({ queryKey: ['positions'], queryFn: getPositions }),
      ]);
    };
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center gap-8">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-3xl font-bold text-white tracking-tight">TrackCore</h1>
            <p className="text-blue-300 text-sm font-medium">Plataforma de Rastreamento</p>
          </div>
        </div>
