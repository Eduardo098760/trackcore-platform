      ...
      <div className="flex flex-col w-64 border-r border-white/10 bg-gradient-to-b from-gray-900 via-gray-950 to-black dark:from-gray-950 dark:via-black dark:to-gray-950 backdrop-blur-xl">
        ...
        <div className="relative flex items-center h-16 px-6 border-b border-white/10">
          ...
          <div className="relative flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-lg font-bold bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">Nova Web</h1>
              <p className="text-xs text-blue-400">GPS Tracking Pro</p>
            </div>
          </div>
        </div>
        ...
        <nav className="flex-1 px-3 py-4 overflow-y-auto scrollbar-thin scrollbar-thumb-blue-600/50 scrollbar-track-transparent">
          ...
          <div className="space-y-1">
            <p className="px-3 text-xs font-semibold text-purple-400/70 uppercase tracking-wider mb-2">
              VideoTelemetria
            </p>
          ...
          <div className="space-y-1">
            <p className="px-3 text-xs font-semibold text-blue-400/70 uppercase tracking-wider mb-2">
              Gerenciamento
            </p>
            {management.map((item) => {
              const isActive = pathname === item.href;
